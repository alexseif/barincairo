...
async def test_admin_category_crud():
    """Test Category list, create GET, create POST, details, and teardown cleanup."""
...
async def test_admin_vibe_tag_crud():
    """Test VibeTag list, create GET, create POST, details, and teardown cleanup."""
...
async def test_admin_venue_crud_and_spatial_helpers():
    """Test Venue list, create form GET, create POST with lat/lng, details view, and teardown cleanup."""
...
async def test_admin_venue_staging_crud():
    """Test VenueStaging list, create form GET, create POST, details view, and teardown cleanup."""
