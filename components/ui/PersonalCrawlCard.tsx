        ...
        <div className="flex max-w-xl flex-col justify-between gap-8 lg:justify-self-end">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              ...
              className="flex h-12 min-h-[44px] min-w-[44px] items-center justify-center gap-2 bg-[#24332d] px-6 font-mono text-[0.75rem] uppercase tracking-[0.16em] text-[#ede7d8] transition-colors hover:bg-accent hover:text-primary-foreground"
            >
            ...
            <a
              ...
              className="flex h-12 min-h-[44px] min-w-[44px] items-center justify-center gap-2 border border-primary px-6 font-mono text-[0.75rem] uppercase tracking-[0.16em] text-primary transition-colors hover:bg-primary hover:text-primary-foreground"
            >
